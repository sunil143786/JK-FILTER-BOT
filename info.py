...
PICS = (environ.get('PICS', 'https://telegra.ph/file/12ab324d7e6e8dd6a9e39.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',  -1002099763594))
...
# Streaming
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1002099763594")
